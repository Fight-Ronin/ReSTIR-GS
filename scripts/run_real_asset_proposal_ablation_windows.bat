...
"%RESTIRGS_ENV%\python.exe" scripts\demo_09_real_asset_proposal_ablation.py --ply "%RESTIRGS_PLY%" --camera-config "%RESTIRGS_CAMERA_CONFIG%" --num-lights 128 --max-gaussians 200000 --k-values 1,2,4,8,16,32 --seed-count 8 --output-dir outputs
