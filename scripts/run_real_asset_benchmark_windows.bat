...
if not defined RESTIRGS_BENCHMARK_MANIFEST set "RESTIRGS_BENCHMARK_MANIFEST=configs\real_asset_benchmark.json"
...
"%RESTIRGS_ENV%\python.exe" scripts\demo_15_real_asset_benchmark.py --manifest "%RESTIRGS_BENCHMARK_MANIFEST%" --device cuda
