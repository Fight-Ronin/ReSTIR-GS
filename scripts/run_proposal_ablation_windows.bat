...
"%RESTIRGS_ENV%\python.exe" scripts\demo_05_proposal_ablation.py --width 128 --height 128 --num-lights 128 --k-values 1,2,4,8,16,32 --seed-count 8 --output-dir outputs
