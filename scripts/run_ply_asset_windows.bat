...
if defined RESTIRGS_CAMERA_CONFIG (
  "%RESTIRGS_ENV%\python.exe" scripts\demo_07_ply_asset_baseline.py --ply "%RESTIRGS_PLY%" --width 128 --height 128 --num-lights 128 --candidate-count 8 --max-gaussians 200000 --output-dir outputs --camera-config "%RESTIRGS_CAMERA_CONFIG%"
) else (
  "%RESTIRGS_ENV%\python.exe" scripts\demo_07_ply_asset_baseline.py --ply "%RESTIRGS_PLY%" --width 128 --height 128 --num-lights 128 --candidate-count 8 --max-gaussians 200000 --output-dir outputs
)
