...
def read_ply_header(path: Path) -> dict[str, object]:
    ...
    with path.open("rb") as handle:
        ...
        if first != "ply":
            return {"format": "", "vertex_count": 0, "properties": [], "saw_end_header": False}
        for raw_line in handle:
            ...
            if line.startswith("format "):
                ...
                saw_end_header = True
                break
    return {"format": ply_format, "vertex_count": vertex_count, "properties": properties, "saw_end_header": saw_end_header}
